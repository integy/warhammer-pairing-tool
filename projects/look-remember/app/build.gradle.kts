...
val _sdkLocalPropsFile = File("/Users/eric/.openclaw/workspace/projects/xg-glass", "local.properties")
...
android {
    ...
    defaultConfig {
        applicationId = "com.example.lookremember"
        minSdk = appMinSdk
        targetSdk = 34
        versionCode = 1
        versionName = "0.0.1"
...
ugRayneo {
    ...
    appEntryClass.set("com.example.xgglassapp.logic.LookRememberEntry")
    ...
    mercuryAarDir.set(file("/Users/eric/.openclaw/workspace/projects/xg-glass/third_party/rayneo/aar").absolutePath)
